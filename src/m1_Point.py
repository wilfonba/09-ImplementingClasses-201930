...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.x = x
        self.y = y
        self.distTraveled = self.distTraveled + (dx**2 + dy**2)**0.5
    ...
    def get_distance_from_start(self):
        distFromStartX = self.x - self.ix
        distFromStartY = self.y - self.iy
        return (distFromStartX**2 + distFromStartY**2)**0.5
